  ...
  var d = "2.8.3",
    ...
    y = function(a, c, d, e) {
      ...
      return (
        ...
        (f = ["&blue;", '<style id="s', h, '">', a, "</style>"].join("")),
        (l.id = h),
        ((m ? l : n).innerHTML += f),
        n.appendChild(l),
        m ||
  ...
  !E(A, "undefined") && !E(A.call, "undefined")
    ...
    (s.rgba = function() {
      return (
        ...
        C("background-color:blue"), F(j.backgroundColor, "rgba")
      );
    }),
    (s.hsla = function() {
      return (
    ...
    (s.cssgradients = function() {
      var a = "background-image:",
        b = "gradient(linear,left top,right bottom,from(blue),to(white));",
        c = "linear-gradient(left top,blue, white);";
